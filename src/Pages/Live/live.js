    ...
    <>
      ...
      <Container className="dashboardpart">
        ...
        <Card style={{ width: "50rem" }} className="mb-2">
          <Card.Body>
            <div  className="d-flex">
              <h2>Select a <span style={{color: "blue"}}>critearea</span> </h2>
            ...
            <Button className=" btn-lg" variant="info">
              <i class="fas fa-mobile-alt mr-2"></i>Average attention & focused of all device{" "}
            </Button>
            <div>
        ...
        <Card style={{ width: "50rem" }} className="mb-2">
          <Card.Body>
          <Button className=" btn-lg" variant="info">
              <i class="fas fa-mobile-alt mr-2"></i>High attention & focused of all device{" "}
            </Button>
            <div>
              <Button className="" variant="primary">
        ...
        <Card style={{ width: "50rem" }} className="mb-2">
          <Card.Body>
          <Button className=" btn-lg" variant="info">
              <i class="fas fa-mobile-alt mr-2"></i>Low attention & focused of all device{" "}
            </Button>
            <div>
              <Button className="" variant="primary">
                <i class="fas fa-user-tie mr-2"></i> device 4{" "}
